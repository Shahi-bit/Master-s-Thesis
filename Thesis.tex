...
The shape of the fibers and the distribution of their diameters were studied using a \textbf{SEM, TESCAN VEGA3, Czech Republic}, with support from the NUST MISIS.
...
using ImageJ software.The contact angles were then used to calculate the work of adhesion (Wa) and the surface free energy (\(\gamma\)).
\begin{figure}[h!]
\centering
